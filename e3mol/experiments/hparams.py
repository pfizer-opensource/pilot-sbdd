...
def add_arguments(parser):
    ...
    parser.add_argument("--test-save-dir", type=str)
    ...
    parser.add_argument("--addNumHs", default=False, action="store_true")
    parser.add_argument("--addHybridization", default=False, action="store_true")
    ...
    # DIFFUSION
    parser.add_argument(
        "--model", default="diffusion", type=str, choices=["diffusion", "flow"]
    )
    parser.add_argument("--context-pos-noise", default=0.0, type=float)
    parser.add_argument("--include-field-repr", default=False, action="store_true")
    parser.add_argument("--timesteps", default=500, type=int)
    parser.add_argument("--node-level-t", default=False, action="store_true")
    parser.add_argument("--fragmentation", default=False, action="store_true")
    parser.add_argument(
        "--fragmentation-method",
        default="recap",
        choices=["recap", "briccs", "cuttable", "recap-briccs", "briccs-recap"],
    )
    parser.add_argument("--include-middle-fragment", default=False, action="store_true")
    parser.add_argument("--minimum-fragment-size", default=6, type=int)
    parser.add_argument("--cuttable-pattern", default="cut_Amides", type=str)
    parser.add_argument("--fragmentation-mix", default=False, action="store_true")
    parser.add_argument(
        "--fragment-prior", default="anchor", choices=["anchor", "fragment"]
    )
    parser.add_argument(
        "--t-cond-frac",
        default=0.5,
        type=float,
        help="Probability to perform conditional learning (fragment) vs unconditiional during training",
    )

    parser.add_argument("--ot-alignment", default=False, action="store_true")
    parser.add_argument("--apply-kabsch", default=False, action="store_true")
    ...
    parser.add_argument("--com-ligand", default=False, action="store_true")
    parser.add_argument("--constrained-flow", default=False, action="store_true")
    parser.add_argument("--model-score", default=False, action="store_true")
    parser.add_argument("--omit-intermediate-noise", default=False, action="store_true")
    parser.add_argument(
        "--gamma2-func", default="t(1-t)", choices=["t(1-t)", "2t(1-t)"], type=str
    )
    ...
    parser.add_argument("--num-atom-types", default=17, type=int)
