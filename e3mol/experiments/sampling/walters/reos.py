# Taken from https://github.com/Dunni3/FlowMol/blob/main/flowmol/analysis/reos.py
...
class REOS:
    """
    Wrapper class for userful_rdkit_utils.reos.REOS
    that implements structural alert counting in a way that suits our needs
    ."""
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.smarts_arr = []
        for desc, rule_set_name, smarts in self.reos.active_rule_df[
            ["description", "rule_set_name", "smarts"]
        ].values:
    ...
    def mol_to_flags(self, mol):
        ...
        flags_found = set()
        for desc, rule_set_name, _, pat, max_val in self.reos.active_rule_df[
            cols
        ].values:
