...
from .system_prep import MDAnalysisInferer, SystemPrep
...
class FilePrep:
    ...
    def split_complex(
        self,
        complex_file: str,
        bond_order_infering: Optional[Callable[[Chem.Mol], Chem.Mol]] = None,
    ) -> None:
        if bond_order_infering is None:
            bond_order_infering = MDAnalysisInferer(reorder=False, sanitize=True)
