...
class Settings:
    ...
    interactions: list[str] = field(
        default_factory=lambda: [
            ...
            "XBAcceptor",
            "XBDonor",
            "Hydrophobic",  # added hydrophobic interaction
            "EdgeToFace",  # added EdgeToFace interaction
            "FaceToFace",  # added FaceToFace interaction
        ]
    )
    interaction_parameters: dict[str, dict] = field(
        default_factory=lambda: {
            ...
            "EdgeToFace": {"distance": 5.5},
            "FaceToFace": {"distance": 4.5},
        }
    )
